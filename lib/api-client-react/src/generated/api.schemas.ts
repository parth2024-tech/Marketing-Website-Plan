...
export interface HabitAnswersMap {[key: string]: number}
...
export type PairSessionPollResponseStatus = typeof PairSessionPollResponseStatus[keyof typeof PairSessionPollResponseStatus];
