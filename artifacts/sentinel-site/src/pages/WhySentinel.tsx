      ...
      <section className="px-6 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            {failures.map((f) => (
              <div key={f.tool} className="surface-card rounded-xl overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {sentinelAdvantages.map((a) => (
              <div key={a.title} className="surface-card rounded-xl p-7 flex gap-5">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {realScenarios.map((s, i) => (
              <div key={i} className="surface-card rounded-xl p-7">
